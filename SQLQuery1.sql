...
(ImageUrl, [Address], [Name], Telephone, OpenDate, [Description]) VALUES 
...
INSERT INTO Patrons
([Address], DateOfBirth, FirstName, HomeLibraryBranchId, LastName, LibraryCardId, Telephone) VALUES
...
('Book', 11.99, 1, 2, 'Alice Walker',	'820.298', '9780151191543', 'The Color Purple', 1982, NULL, '/images/thepurplecolor.png', 2),
('Book', 12.50, 1, 2, 'Gabriel García Márquez', '821.544', '9789631420494', 'One Hundred Years of Solitude', 1967, NULL, '/images/onehundredyearsofsolitude.png', 1),
...
('Video', 24.00, 1, 2, NULL, NULL, 'N/A', 'Blue Velvet',	1986, 'David Lynch', '/images/default.png', 1),
('Video', 24.00, 1, 2, NULL, NULL, 'N/A', 'Trois Coleurs: Rouge', 1994, 'Krzysztof Kieslowski', '/images/default.png', 1),
('Video', 30.00, 1, 2, NULL, NULL, 'N/A', 'Citizen Kane',	1941, 'Orson Welles', '/images/default.png', 1),
('Video', 28.00, 2, 2, NULL, NULL, 'N/A', 'Spirited Away',	2002, 'Hayao Miyazaki', '/images/default.png', 1),
('Video', 23.00, 2, 2, NULL, NULL, 'N/A', 'The Departed',	2006, 'Martin Scorsese', '/images/default.png', 1),
('Video', 17.99, 2, 2, NULL, NULL, 'N/A', 'Taxi Driver', 1976, 'Martin Scorsese', '/images/default.png', 1),
('Video', 18.00, 3, 2, NULL, NULL, 'N/A', 'Casablanca',	1943, 'Michael Curtiz', '/images/default.png', 1);
